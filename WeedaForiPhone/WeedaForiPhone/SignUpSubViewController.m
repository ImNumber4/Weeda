...
- (void)viewDidLoad {
    ...
    self.titleLabel.textColor = [ColorDefinition greenColor];
    ...
    self.inputField.textColor = [ColorDefinition greenColor];
    ...
    [self.continueButton setBackgroundColor:[ColorDefinition greenColor]];
