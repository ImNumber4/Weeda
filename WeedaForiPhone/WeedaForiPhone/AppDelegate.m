...
- (void)setupRestKit{
    ...
    NSString *storePath = [RKApplicationDataDirectory() stringByAppendingPathComponent:@"Weeds.sqlite"];
...
- (NSManagedObjectModel *)managedObjectModel
{
    ...
    NSURL *modelURL = [[NSBundle mainBundle] URLForResource:@"WeedaForiPhone" withExtension:@"momd"];
...
- (NSPersistentStoreCoordinator *)persistentStoreCoordinator
{
    ...
    NSURL *storeURL = [[self applicationDocumentsDirectory] URLByAppendingPathComponent:@"WeedaForiPhone.sqlite"];
