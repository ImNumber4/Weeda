...
class MessageDAO extends BaseDAO
{
	public function create($message, $notification_message) {
		$query = 'INSERT INTO message (sender_id, receiver_id, message, type, related_weed_id, image_metadata, time) VALUES ('
				...
				. ($message->get_image_metadata() == NULL ? 'NULL' : $message->get_image_metadata()) . '\',\''  
				. $message->get_time() . '\')';
